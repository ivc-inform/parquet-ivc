...
public class AvroParquetWriter<T> extends ParquetWriter<T> {
  ...
  /** Create a new {@link ru.mfms.parquet.avro.AvroParquetWriter}.
   *
   * @param file
   * @param avroSchema
  ...
  public AvroParquetWriter(Path file, Schema avroSchema,
    ...
    super(file, ru.mfms.parquet.avro.AvroParquetWriter.<T>writeSupport(avroSchema, SpecificData.get()),
  ...
  /** Create a new {@link ru.mfms.parquet.avro.AvroParquetWriter}. The default block size is 50 MB.The default
  ...
  public AvroParquetWriter(Path file, Schema avroSchema,
    ...
    this(file,
        ru.mfms.parquet.avro.AvroParquetWriter.<T>writeSupport(conf, avroSchema, SpecificData.get()),
        compressionCodecName, blockSize, pageSize,
  ...
  public static class Builder<T> extends ParquetWriter.Builder<T, Builder<T>> {
    ...
    protected WriteSupport<T> getWriteSupport(Configuration conf) {
      return ru.mfms.parquet.avro.AvroParquetWriter.writeSupport(conf, schema, model);
    }
  }
}
