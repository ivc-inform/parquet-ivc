...
public class AvroWriteSupport<T> extends WriteSupport<T> {
  ...
  /**
   * @deprecated use {@link ru.mfms.parquet.avro.AvroWriteSupport ( MessageType , Schema , Configuration )}
   */
  @Deprecated
  ...
  /**
   * @see ru.mfms.parquet.avro.AvroParquetOutputFormat#setSchema(org.apache.hadoop.mapreduce.Job, org.apache.avro.Schema)
   */
