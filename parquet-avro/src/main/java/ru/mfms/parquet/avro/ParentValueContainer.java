...
abstract class ParentValueContainer {
  ...
  static class LogicalTypePrimitiveContainer extends ru.mfms.parquet.avro.ParentValueContainer {
    private final ru.mfms.parquet.avro.ParentValueContainer wrapped;
    private final Schema schema;
    private final LogicalType logicalType;
    private final Conversion conversion;

    public LogicalTypePrimitiveContainer(ru.mfms.parquet.avro.ParentValueContainer wrapped,
  ...
  static ru.mfms.parquet.avro.ParentValueContainer getConversionContainer(
          final ru.mfms.parquet.avro.ParentValueContainer parent, final Conversion<?> conversion,
          final Schema schema) {
    if (conversion == null) {
      return parent;
    }
    ...
    switch (schema.getType()) {
      case STRING:
        return new ru.mfms.parquet.avro.ParentValueContainer() {
          @Override
          public void add(Object value) {
